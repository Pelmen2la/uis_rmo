...
function getCallPersonProps(callData) {
    ...
    return {
        ...
        id: isEmployeeCall ? callData.employee_id : callData.contact_id,
        type: isEmployeeCall ? 'employee' : 'contact'
    };
};
...
module.exports = {
    ...
    getCallPersonProps: getCallPersonProps
};